...
$$
    ...
    \end{bmatrix}
    \\
    A_{11},B_{11} \in M_{k},A_{12},B_12 \in M_{k,n-k} \\
    A_{21}, \in M_{n-k,k},A_{22} \in M_{n-k,n-k} \\
...
$$
    A_{11}B_{12} + A_{12}B_{22} = 0_{k,n-k} \\
    A_{21}B_{11} + A_{22}B_{12} = 0_{n-k,k} \\
    B_{22} = -A_{12}^{-1}A_{11}B_{12} \\
    or \\
    B_{12} = A_{11}^{-1}A_{12}B_{22} \\
    with \\
    B_{11} = -A_{21}^{-1}A_{22}B_{21} \\
    or \\
    B_{21} = -A_{22}^{}A_{21}B_{11}
$$

将从 $0_{k,n-k}$ 的等式得到的 $B_{22}$ 与 $B_{12}$ 的关系带入到 $I_{n-k,n-k}$ $M_{11}$ 中

将从 $0_{n-k,k}$ 的等式得到的 $B_{11}$ 与 $B_{21}$ 的关系带入到 $I_{k,k}$ $M_22$ 中

根据 

$$
    I_{n-k,n-k} = A_{21}B_{12} + A_{22}B_{22} \\
                = A_{21}B_{12} - A_{22}A_{12}^{-1}A_{11}B_{12} \\
                = (A_{21}- A_{22}A_{12}^{-1}A_{11})B_{12} \\
    B_{12} = (A_{21} - A_{22}A_{12}^{-1}A_{11})^{-1} \\
    B_{22} = (-A_{21}A_{11}A_{12}^{-1} + A_{22})^{-1} \\
    I_{k,k} = A_{11}B_{11} + A_{12}B_{21} \\
            = A_{11}A_{21}^{-1}A_{22}B_{21} + A_{12}B_{21}\\
    B_{21} =(A_{12} + A_{11}A_{21}^{-1}A{22})^{-1}
     = (A_11A_{21}A_{22})
$$
